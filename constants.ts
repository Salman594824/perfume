...
const AdminPanel: React.FC<AdminPanelProps> = ({ 
  ...
  const handleGlobalSettingsUpdate = (e: React.FormEvent) => {
    ...
    alert("Global Settings Deployed Locally.");
  };
  ...
  // GENERATE CODE FOR constants.ts
        ...
        <div className="flex-1">
          {activeTab === 'dashboard' && (
            <div className="animate-fadeIn space-y-8">
              ...
              {/* CLARIFICATION ALERT FOR THE USER */}
              <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/30 p-10 rounded-[2rem]">
                 <div className="flex items-center gap-4 mb-4">
                    <Database className="text-[#D4AF37]" size={24} />
                    <h3 className="text-xl serif text-[#041A13]">Important: Permanent Saving Guide</h3>
                 </div>
                 <p className="text-sm text-[#041A13]/80 leading-relaxed mb-6">
                   Aap jo bhi changes yahan kar rahe hain, wo sirf aapke current browser mein save ho rahi hain. In changes ko hamesha ke liye (GitHub par) save karne ke liye:
                 </p>
                 <ol className="text-xs text-[#041A13]/70 space-y-2 list-decimal ml-4 font-medium uppercase tracking-wider">
                    <li>Apni changes yahan Admin Panel mein mukammal karen.</li>
                    <li><strong>"Storefront Settings"</strong> tab mein jayen.</li>
                    <li><strong>"Generate Source Code"</strong> par click karen.</li>
                    <li>Code copy karke apne project ki <strong>constants.ts</strong> file mein paste kar den.</li>
                 </ol>
              </div>
            </div>
          )}
            ...
            <div className="space-y-8 animate-fadeIn">
                ...
                <form onSubmit={handleGlobalSettingsUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <div className="md:col-span-2 flex justify-end">
                    <button type="submit" className="bg-black text-white px-12 py-5 rounded-full text-[11px] font-bold uppercase tracking-widest hover:bg-[#D4AF37] transition-all flex items-center gap-3">
                      <Save size={18} /> Deploy Settings Locally
                    </button>
                  </div>
                </form>
              </div>
              ...
              <div className="bg-[#041A13] rounded-2xl shadow-xl p-12 text-white overflow-hidden relative">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-2xl serif">Permanent Vault Synchronization</h3>
                </div>
                <p className="text-sm opacity-70 leading-relaxed max-w-2xl mb-10">
                  Static site par changes ko permanent karne ke liye aapko <strong>constants.ts</strong> file update karni paray gi. 
                  Yahan click karke wo code hasil karen jo aapko apni file mein paste karna hai.
                </p>
      ...
      {showCodeGen && (
        <div className="fixed inset-0 z-[400] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-4xl rounded-[2.5rem] p-12 shadow-2xl animate-fadeIn max-h-[90vh] flex flex-col">
            ...
            <p className="text-sm text-gray-500 mb-8">Neechay diya gaya code copy karen aur apni <strong>constants.ts</strong> file ke saaray content ko is se replace kar den.</p>
      ...
      {isEditingProduct && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-3xl p-10 shadow-2xl animate-fadeIn max-h-[90vh] flex flex-col">
            ...
            <button onClick={handleSaveProduct} className="w-full bg-[#041A13] text-white py-5 rounded-full text-[11px] font-bold uppercase tracking-widest hover:bg-[#D4AF37] transition-all mt-4">Save to Local Vault</button>
          </div>
        </div>
      )}
    </div>
