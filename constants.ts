...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'Women',
    stockStatus: StockStatus.IN_STOCK,
    images: ['https://images.unsplash.com/photo-1503104834685-7205e8607eb9?auto=format&fit=crop&q=80&w=800'],
    notes: {
...
export const INITIAL_SETTINGS: SiteSettings = {
  ...
  social: {
    instagram: 'https://instagram.com/montclaire01',
    pinterest: 'https://pinterest.com/montclaire91',
    whatsapp: 'https://wa.me/923371292112',
    tiktok: 'https://tiktok.com/@montclaire001'
  },
  newsletter: {
